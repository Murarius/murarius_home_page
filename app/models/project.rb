...
class Project < ActiveRecord::Base
  ...
  validates :github_link, format: { with: VALID_LINK_REGEX, multiline: true }, allow_blank: true
  validates :demo_link, format: { with: VALID_LINK_REGEX, multiline: true }, allow_blank: true
end
